...
const char COMMUNITY_FORUM_URL[] = "https://mitocointalk.org";
const char REPORT_ISSUE_URL[] = "https://mitocoin.org/contact";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Mitocoin Wallet %1").arg(Settings::instance().getVersion()));
