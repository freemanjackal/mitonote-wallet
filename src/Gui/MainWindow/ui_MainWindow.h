...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/mitocoin"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutMitocoinAction = new QAction(MainWindow);
        m_aboutMitocoinAction->setObjectName(QStringLiteral("m_aboutMitocoinAction"));
        m_aboutMitocoinAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutMitocoinAction);
        ...
        QObject::connect(m_aboutMitocoinAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
...
#endif // QT_NO_TOOLTIP
        m_aboutMitocoinAction->setText(QApplication::translate("MainWindow", "About Mitocoin", 0));
